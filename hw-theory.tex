...
библиотеки \verb!Relation/Equivalence.ard!, тип данных \verb!Quotient!) имеет частичную обратную.
\item Покажите, что если любая сюрьективная функция из факторизованного множества (файл стандартной
библиотеки \verb!Relation/Equivalence.ard!, тип данных \verb!Quotient!) имеет частичную обратную, то выполнена аксиома выбора.
\end{enumerate}
